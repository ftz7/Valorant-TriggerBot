...
void Triggerbot::print_banner() {
    system("cls");
    disable_quickedit();
    SetConsoleTitleW(L"CYBERCLIENT v1.0");
    printf("\n");

    printf("______________.___._______________________________ \n");
    printf("\\_ ___ \\__ | |\\______ \\_ _____/\\______ \\ \n");
    printf("/ \\ \\// | | | | | _/| __)_ | _/ \n");
    printf("\\ \\___\\____ | | | \\| \\ | \\ \n");
    printf(" \\______ / ______ |______ /_______ / |____|_ / \n");
    printf(" \\/ \\/ \\/ \\/ \n");

    printf("\n");
    printf("\n");

    printf("Join us on Discord: discord.gg/cyberclient\n");
